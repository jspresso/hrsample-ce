 ...
 * @hibernate.class table = "COMPANY" dynamic-insert = "true" dynamic-update =
 *                  "true" persister =
 ...
 */
public interface Company extends com.d2s.hrsample.model.Nameable,
   ...
   */
  void addToDepartments(
      com.d2s.hrsample.model.Department departmentsElement);
   ...
   *                inverse = "true"
   * @hibernate.key column = "COMPANY_ID"
   * @hibernate.one-to-many class =
   *                        "com.d2s.hrsample.model.Department"
   ...
   *                inverse = "true"
   * @hibernate.key column = "COMPANY_ID"
   * @hibernate.one-to-many class = "com.d2s.hrsample.model.Employee"
   ...
   */
  void removeFromEmployees(
      com.d2s.hrsample.model.Employee employeesElement);
   ...
   */
  void setDepartments(
      java.util.Set<com.d2s.hrsample.model.Department> departments);
   ...
   */
  void setEmployees(
      java.util.Set<com.d2s.hrsample.model.Employee> employees);
